# Enumerable
 ...
 Program based on Ruby to Enumerable methods
...
**Enumerable** is a program that provides collection classes with several traversal and searching methods, and with the ability to sort.
...
```bash
git clone git@github.com:Cabraham1/Ruby-Enumerable.git
```
